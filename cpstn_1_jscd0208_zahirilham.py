...
def data_peminjam():
        ...
        if namaPeminjam.isdigit():
                print('Nama tidak boleh terdiri dari kombinasi huruf dan angka')
        else:
            ...
            if NoTelp.isdigit() and len(NoTelp) >= 10 and len(NoTelp) <=12 and NoTelp[0]=='0' and NoTelp[1]== '8':
                    ...
                    if judul_Buku_Pinjam in list_judul:
                            checkout= input("Apakah Anda Yakin Ingin meminjam Buku Tersebut (Y/N) : ").lower()
                            if checkout == 'y':
                                os.system("cls")
                                for buku in list_buku:
                                    if buku['Judul']==judul_Buku_Pinjam and int(buku['Stok'])>1:
                                            ...
                                            tabel2(peminjam)
                                    elif buku['Judul']==judul_Buku_Pinjam and int(buku['Stok'])==0:
...
def create_():
        while True:
                ...
                if pilihan_menu_create == '1':
                        ...
                        if id_baru.isdigit():  
                                if id_baru not in list_ID and id_baru.isdigit():
                        ...
                        for buku in list_buku:
                                if buku['No ID']==idBuku:
                                        ...
                                        if GantiPenulis == 'y':
                                                os.system("cls")
                                                filter_ID(idBuku)
                                                editpenulis=input('Edit Penulis : ').title()
                                                if editpenulis.isdigit():
                                                        print('Nama harus berupa huruf')
                                                else:        
                                                        buku['Penulis']= editpenulis
                                        else :
                                                os.system("cls")
                                                filter_ID(idBuku)
