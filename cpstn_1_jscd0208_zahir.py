...
list_peminjam = [{'Nama Peminjam' : 'Ujang Usep', 'Alamat Peminjam' : 'Jl. Konoha 12 No.99', 'No Telp' : '081324664645', 'Judul' : 'Vagabond'}]
...
def data_peminjam():
        ...
        if NoTelp.isdigit() and len(NoTelp) >= 10 and NoTelp[0]=='0' and NoTelp[1]== '8':
                        ...
                        for buku in list_buku:
                                if buku['No ID']==idBuku:
                                        ...
                                        if GantiPenulis == 'y':
                                                os.system("cls")
                                                filter_ID(idBuku)
                                                buku['Penulis']= input('Edit Penulis : ')
                                        else :
                                                os.system("cls")
                                                filter_ID(idBuku)
